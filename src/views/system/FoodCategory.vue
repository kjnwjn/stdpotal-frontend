...
export default {
    ...
    methods: {
        ...
        async categoryRemoveHandler(categoryId) {
            this.isLoading = true;
            await axios
                .delete(`${process.env.VUE_APP_API_GATEWAY}/category/remove-category/${categoryId}?token=${this.accessToken}`)
                .then((res) => {
                    if (res.data.status) {
        ...
        async newCategory() {
            this.isLoading = true;
            await axios
                .post(`${process.env.VUE_APP_API_GATEWAY}/category/new-category?token=${this.accessToken}`, {
        ...
        async fetchData() {
            this.isLoading = true;
            await axios
                .get(`${process.env.VUE_APP_API_GATEWAY}/category/get-all?token=${this.accessToken}`)
                .then((res) => {
