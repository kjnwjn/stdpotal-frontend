    ...
    methods: {
        ...
        async visualizeHandler() {
            if (this.startDate && this.endDate) {
                ...
                await axios.get(`${process.env.VUE_APP_API_GATEWAY}/transaction/visualize/?dateFrom=${dateFrom}&dateTo=${dateTo}&token=${this.accessToken}`).then((res) => {
        ...
        async exportHandler() {
            ...
            const dateTo = `${dayTo}/${monthTo}/${yearTo}`;
            await axios({
                url: `${process.env.VUE_APP_API_GATEWAY}/transaction/visualize/export?dateFrom=${dateFrom}&dateTo=${dateTo}&token=${this.accessToken}`,
                method: "GET",
                responseType: "blob",
            }).then((response) => {
